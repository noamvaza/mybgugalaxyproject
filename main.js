(function($){
  ...
  Renderer = function(canvas){
    ...
    redraw:function(){
        ...
        particleSystem.eachNode(function(node, pt){
            ...
            if (label){
                ...
                ctx.fillStyle = node.data.color? node.data.color : "#009";
        ...
        resize:function(){
            ...
            that.redraw();
            $('#log').width( $(window).width() - w - 80 );
            $('#log').height( h );
            $('#controls').height( $(window).height()-h-30 );
        },
    ...
    $(document).ready(function(){
        sys = arbor.ParticleSystem(4000, 500, 0.5, 55); // create the system with sensible repulsion/stiffness/friction
